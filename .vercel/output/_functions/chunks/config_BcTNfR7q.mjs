...
import { A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, a as createComponent, r as renderTemplate, u as unescapeHTML, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, d as renderComponent } from './astro/server_DuJbMrHn.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Ct8-vJi1.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://www.delioos.xyz", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_7MD8eNFE.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Rie6pq5m.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Ca-O6I9M.mjs');
...
const config = {
    ...
    latestPosts: 3,
    postsPerPage: 3,
    url: "https://delioos.xyz",
    social: {
        'dribbble': false,
        'facebook': false,
        'github': 'https://github.com/delioos',
        'instagram': false,
        'mastodon': false,
        'pinterest': false,
        'skype': false,
...
export { getEntry as a, config as c, getCollection as g };
