...
While smart contracts are immutable by default, proxy patterns enable controlled upgradability. The [**EIP-1967**](https://eips.ethereum.org/EIPS/eip-1967) standard provides a robust framework for upgradeable contracts, giving teams the ability to fix security vulnerabilities, add new features, and optimize gas costs without compromising security.
